...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/proprietary/vendor/firmware/bcm43455_V0147_0248.hcd:system/vendor/firmware/bcm43455_V0147_0248.hcd \
    ...
    $(LOCAL_PATH)/proprietary/etc/wifi/bcmdhd_apsta.bin_blob:system/etc/wifi/bcmdhd_apsta.bin_blob \
    $(LOCAL_PATH)/proprietary/etc/wifi/bcmdhd_clm.blob:system/etc/wifi/bcmdhd_clm.blob \
    $(LOCAL_PATH)/proprietary/etc/wifi/bcmdhd_mfg.bin:system/etc/wifi/bcmdhd_mfg.bin \
    $(LOCAL_PATH)/proprietary/etc/wifi/bcmdhd_mfg.bin_blob:system/etc/wifi/bcmdhd_mfg.bin_blob \
    $(LOCAL_PATH)/proprietary/etc/wifi/bcmdhd_sta.bin:system/etc/wifi/bcmdhd_sta.bin \
    $(LOCAL_PATH)/proprietary/etc/wifi/bcmdhd_sta.bin_blob:system/etc/wifi/bcmdhd_sta.bin_blob \
